...
export const skinTreatmentsList = [
  ...
  },
  {
    ...
    description: 'Targeted protocols to soften acne scars and restore smoother skin texture.',
  ...
  },
  {
    ...
    description: 'Evidence-based care for melasma, sun spots, and uneven pigment patterns.',
    image: '/treatments/skin/pigmentation-treatment.jpg',
    path: '/skin',
    benefits: ['Spot reduction focus', 'Customised plans', 'Sun-care guidance'],
  },
  {
    id: 'skin-rejuvenation',
    title: 'Skin Rejuvenation',
    description: 'Revitalising facial therapies that refresh dull, tired, or stressed skin.',
  ...
  },
  {
    ...
    description: 'Advanced energy-based therapies for tone, texture, and selected concerns.',
    image: '/treatments/skin/laser-skin-therapy.jpg',
    path: '/contact',
    benefits: ['Precision targeting', 'Specialist protocols', 'Measured results'],
  },
  {
    id: 'facial-treatments',
    title: 'Facial Treatments',
    description: 'Curated medical facials tailored to your skin type and glow goals.',
    image: '/treatments/skin/facial-treatments.jpg',
    path: '/treatments/korean-glass-skin-facial',
    benefits: ['Personalised rituals', 'Luxury experience', 'Visible freshness'],
  },
];
