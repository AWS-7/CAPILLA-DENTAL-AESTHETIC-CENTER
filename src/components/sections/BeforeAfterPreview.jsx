...
import { Container, SectionTitle, PrimaryButton, MobileSwiper } from '../common';
import { beforeAfterItems } from '../../data/home';
import { staggerContainer, staggerItem } from '../../utils/animations';

function BeforeAfterCard({ item }) {
  return (
    <article className="h-full overflow-hidden rounded-3xl border border-border bg-light-bg shadow-soft">
    ...
    <section className="section-padding bg-primary-white">
      <Container>
        ...
        <motion.div
          ...
          className="hidden md:grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5 md:gap-8"
        >
          {beforeAfterItems.map((item) => (
