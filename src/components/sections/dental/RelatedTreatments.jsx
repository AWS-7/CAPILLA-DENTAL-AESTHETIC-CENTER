...
import { getRelatedDentalTreatments } from '../../../data/dental';
import { staggerContainer, staggerItem } from '../../../utils/animations';

export default function RelatedTreatments({ slugs = [] }) {
  const items = getRelatedDentalTreatments(slugs);
    ...
    <section className="section-padding bg-primary-white">
      <Container>
        <SectionTitle
          ...
          description="Complementary dental solutions patients often consider alongside this treatment."
        />
        <motion.div
