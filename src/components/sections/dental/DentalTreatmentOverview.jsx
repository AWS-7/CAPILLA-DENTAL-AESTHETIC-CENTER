    ...
    <section className="section-padding bg-primary-white">
      <Container>
        <SectionTitle
          ...
          description="From implants to smile makeovers — comprehensive dentistry for patients across Perumbakkam, Medavakkam, and Sholinganallur."
        />
        <motion.div
