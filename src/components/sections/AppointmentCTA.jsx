    ...
    <section className="section-padding bg-primary-white">
      <Container>
        <motion.div
          ...
          className="relative overflow-hidden rounded-3xl md:rounded-4xl bg-dark-bg px-8 py-16 md:px-16 md:py-20 text-center"
        >
          ...
          <div className="relative z-10 mx-auto max-w-3xl">
            ...
            <h2 className="font-display text-3xl sm:text-4xl md:text-5xl lg:text-[3.5rem] text-primary-white">
