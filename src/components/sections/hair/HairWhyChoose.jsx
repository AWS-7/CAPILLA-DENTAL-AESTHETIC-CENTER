...
import { hairWhyChoose } from '../../../data/hair';
...
export default function HairWhyChoose() {
  return (
    <section className="section-padding bg-light-bg">
      <Container>
        <SectionTitle
          eyebrow="Excellence"
          title="Why Choose Our Hair Clinic"
          description="A luxury hair destination in Perumbakkam built for natural results, sterile care, and specialist-led plans."
        />
        <motion.div
